...
namespace StarterAssets
{
    public class StarterAssetsInputs : MonoBehaviour
    {
        ...
        public void OnAlpha8(InputValue value)
        {
            Alpha8Input(value.isPressed);
        }

        public void OnAlpha9(InputValue value)
        {
        ...
        public void Alpha8Input(bool newAlpha8State)
        {
            alpha8 = newAlpha8State;
        }

        public void Alpha9Input(bool newAlpha9State)
        {
